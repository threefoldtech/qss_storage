...
: >"$fake/blocks/ab/abcdef0123456789"
: >"$fake/blocks/ab/abcdef0123456780"
: >"$fake/blocks/db/000001.sst"
: >"$fake/blocks/.tmp/staged"
: >"$fake/blocks/.quarantine/quarantined"
: >"$fake/blocks/store_header.bin"
st_eq 'block counting sees block files only' 2 "$(qssrt_block_file_count "$fake")"
rm -rf "$fake"
